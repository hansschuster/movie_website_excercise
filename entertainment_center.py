...
dark_knight = media.Movie("Batman - The Dark Knight",
...
life_is_beautiful = media.Movie("Life Is Beautiful",
                                "Set in Fascist Italy, this film tells the story of a Jewish Italian family in"
                                " a concentration camp, and how the father shields their son by"
...
movies = [carnage, braveheart, life_is_beautiful,
